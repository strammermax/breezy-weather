 ...
 * Ethiopia
 */
class EthioMetService @Inject constructor(
    @ApplicationContext injectedContext: Context,
    @Named("JsonClient") val injectedJsonClient: Retrofit.Builder,
) : ClimWebService() {

    override val id = "ethiomet"
    override val countryCode = "ET"
    override val name = "EMI (${injectedContext.currentLocale.getCountryName(countryCode)})"
    ...
    override val baseUrl = "https://www.ethiomet.gov.et/"
    override val instancePreference = R.string.settings_weather_source_ethiomet_instance
