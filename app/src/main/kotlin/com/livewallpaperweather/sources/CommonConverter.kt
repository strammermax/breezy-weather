...
import com.livewallpaperweather.common.extensions.CLOUD_COVER_BKN
import com.livewallpaperweather.common.extensions.CLOUD_COVER_FEW
import com.livewallpaperweather.common.extensions.ensurePositive
...
import com.livewallpaperweather.domain.weather.model.validate
import com.livewallpaperweather.ui.theme.weatherView.WeatherViewController
import com.livewallpaperweather.unit.computing.computeApparentTemperature
import com.livewallpaperweather.unit.computing.computeDewPoint
import com.livewallpaperweather.unit.computing.computeHumidex
import com.livewallpaperweather.unit.computing.computeRelativeHumidity
import com.livewallpaperweather.unit.computing.computeTotalPrecipitation
import com.livewallpaperweather.unit.computing.computeTotalProbabilityOfPrecipitation
import com.livewallpaperweather.unit.computing.computeWindChillTemperature
...
import com.livewallpaperweather.unit.duration.toValidDailyOrNull
import com.livewallpaperweather.unit.duration.toValidHalfDayOrNull
...
import com.livewallpaperweather.unit.pressure.Pressure.Companion.pascals
import com.livewallpaperweather.unit.ratio.Ratio
import com.livewallpaperweather.unit.ratio.Ratio.Companion.percent
import com.livewallpaperweather.unit.ratio.Ratio.Companion.permille
...
import com.livewallpaperweather.unit.temperature.Temperature.Companion.deciCelsius
...
private fun completeHalfDayFromHourlyList(
    ...
    val initialTemperature = livewallpaperweather.domain.weather.model.Temperature(
...
private fun getHalfDayTemperatureFromHourlyList(
    initialTemperature: livewallpaperweather.domain.weather.model.Temperature?,
    halfDayHourlyList: List<Hourly>,
    isDay: Boolean,
): livewallpaperweather.domain.weather.model.Temperature {
    val newTemperature = initialTemperature ?: livewallpaperweather.domain.weather.model.Temperature()
...
private fun completeCurrentTemperatureFromHourly(
    ...
    hourlyTemperature: livewallpaperweather.domain.weather.model.Temperature?,
    windSpeed: Speed?,
    ...
    return livewallpaperweather.domain.weather.model.Temperature(
