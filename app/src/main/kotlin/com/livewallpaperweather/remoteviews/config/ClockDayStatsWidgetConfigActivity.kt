...
/**
 * Clock day + device stats widget config activity.
 */
@AndroidEntryPoint
class ClockDayStatsWidgetConfigActivity : AbstractWidgetConfigActivity() {
    ...
    override fun updateWidgetView() {
        ClockDayStatsWidgetIMP.updateWidgetView(this, locationNow)
    }

    override val remoteViews: RemoteViews
        get() {
            return ClockDayStatsWidgetIMP.getRemoteViews(
                this,
                locationNow,
                cardStyleValueNow,
                cardAlpha,
    ...
    override val configStoreName: String
        get() {
            return getString(R.string.sp_widget_clock_day_stats_setting)
        }
}
