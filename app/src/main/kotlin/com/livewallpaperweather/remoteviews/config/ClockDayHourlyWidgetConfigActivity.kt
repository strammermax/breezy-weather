...
/**
 * Clock day + hourly strip widget config activity.
 */
@AndroidEntryPoint
class ClockDayHourlyWidgetConfigActivity : AbstractWidgetConfigActivity() {
    ...
    override fun updateWidgetView() {
        ClockDayHourlyWidgetIMP.updateWidgetView(this, locationNow)
    }

    override val remoteViews: RemoteViews
        get() {
            return ClockDayHourlyWidgetIMP.getRemoteViews(
                this,
                locationNow,
                this.getTabletListAdaptiveWidth(resources.displayMetrics.widthPixels),
                cardStyleValueNow,
                cardAlpha,
                textColorValueNow,
                textSize,
    ...
    override val configStoreName: String
        get() {
            return getString(R.string.sp_widget_clock_day_hourly_setting)
        }
}
