...
package com.livewallpaperweather.remoteviews.presenters
...
import com.livewallpaperweather.common.extensions.formatPercent
...
import com.livewallpaperweather.domain.settings.ConfigStore
import com.livewallpaperweather.domain.weather.model.getDescription
...
import com.livewallpaperweather.domain.weather.model.getShortDescription
import com.livewallpaperweather.domain.weather.model.getSummary
import com.livewallpaperweather.domain.weather.model.pollensWithConcentration
        ...
        private fun replaceAlerts(
            ...
            currentAlertList.forEach { currentAlert ->
                ...
                currentAlert.startDate?.let { startDate ->
                    ...
                    defaultBuilder.append(context.getString(com.livewallpaperweather.unit.R.string.locale_separator))
                        .append(startDateDay)
