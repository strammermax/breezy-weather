...
package com.livewallpaperweather.remoteviews.presenters.notification
...
import com.livewallpaperweather.common.extensions.notificationBuilder
import com.livewallpaperweather.common.extensions.notify
import com.livewallpaperweather.common.options.NotificationTextColor
...
import com.livewallpaperweather.domain.weather.model.getStrength
import com.livewallpaperweather.domain.weather.model.getTrendFeelsLikeTemperature
import com.livewallpaperweather.domain.weather.model.getTrendTemperature
import com.livewallpaperweather.remoteviews.Notifications
import com.livewallpaperweather.remoteviews.presenters.AbstractRemoteViewsPresenter
import com.livewallpaperweather.ui.theme.resource.ResourceHelper
...
object MultiCityWidgetNotificationIMP : AbstractRemoteViewsPresenter() {
    ...
    private fun buildBaseView(
        ...
        if (CalendarHelper.getAlternateCalendarSetting(context) != null) {
            timeStr.append(context.getString(com.livewallpaperweather.unit.R.string.locale_separator))
    ...
    private fun getCityTitle(
        ...
        location.weather?.today?.let {
            builder.append(context.getString(com.livewallpaperweather.unit.R.string.locale_separator))
                .append(
                    if (isWidgetNotificationUsingFeelsLike) {
