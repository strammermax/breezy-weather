...
package com.livewallpaperweather.ui.common.widgets.astro
...
import com.livewallpaperweather.ui.common.widgets.DayNightShaderWrapper
...
class SunMoonView @JvmOverloads constructor(
    ...
    private fun ensureShader(
        ...
        mX1ShaderColors[0] = com.livewallpaperweather.common.utils.ColorUtils.blendColor(lineShadowShader, rootColor)
        mX1ShaderColors[1] = rootColor
        mX2ShaderColors[0] = com.livewallpaperweather.common.utils.ColorUtils.blendColor(lineShadowShader, mX1ShaderColors[0])
