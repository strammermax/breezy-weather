...
package com.livewallpaperweather.common.extensions
...
val Context.isBackgroundAnimationEnabled: Boolean
    get() {
        val mode = com.livewallpaperweather.domain.settings.SettingsManager.getInstance(this).backgroundAnimationMode
        return when (mode) {
            com.livewallpaperweather.common.options.appearance.BackgroundAnimationMode.SYSTEM -> !isMotionReduced
            com.livewallpaperweather.common.options.appearance.BackgroundAnimationMode.ENABLED -> true
            com.livewallpaperweather.common.options.appearance.BackgroundAnimationMode.DISABLED -> false
        }
    }
