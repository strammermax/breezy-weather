...
import com.livewallpaperweather.common.options.BaseEnum
...
enum class DetailScreen(
    ...
    companion object {
        ...
        fun getSummary(context: Context, list: List<DetailScreen>): String {
            ...
            return builder.toString().replace(",", context.getString(com.livewallpaperweather.unit.R.string.locale_separator))
        }
    }
