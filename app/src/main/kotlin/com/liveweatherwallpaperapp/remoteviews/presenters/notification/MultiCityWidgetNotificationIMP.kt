...
import com.liveweatherwallpaperapp.domain.weather.model.getTrendFeelsLikeTemperature
...
object MultiCityWidgetNotificationIMP : AbstractRemoteViewsPresenter() {
    ...
    private fun buildBaseView(
        ...
        if (CalendarHelper.getAlternateCalendarSetting(context) != null) {
            timeStr.append(context.getString(com.liveweatherwallpaperapp.unit.R.string.locale_separator))
    ...
    private fun getCityTitle(
        ...
        location.weather?.today?.let {
            builder.append(context.getString(com.liveweatherwallpaperapp.unit.R.string.locale_separator))
                .append(
                    if (isWidgetNotificationUsingFeelsLike) {
