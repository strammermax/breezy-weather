...
import com.liveweatherwallpaperapp.domain.weather.model.getShortDescription
import com.liveweatherwallpaperapp.domain.weather.model.getSummary
import com.liveweatherwallpaperapp.domain.weather.model.pollensWithConcentration
        ...
        private fun replaceAlerts(
            ...
            currentAlertList.forEach { currentAlert ->
                ...
                currentAlert.startDate?.let { startDate ->
                    ...
                    defaultBuilder.append(context.getString(com.liveweatherwallpaperapp.unit.R.string.locale_separator))
                        .append(startDateDay)
