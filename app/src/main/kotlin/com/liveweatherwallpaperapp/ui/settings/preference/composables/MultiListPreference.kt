...
package com.liveweatherwallpaperapp.ui.settings.preference.composables
...
fun MultiListPreferenceView(
    ...
    val currentSummary = listSelectedState.mapNotNull { selectedItem ->
        ...
        .joinToString(stringResource(com.liveweatherwallpaperapp.unit.R.string.locale_separator))
        .ifEmpty {
