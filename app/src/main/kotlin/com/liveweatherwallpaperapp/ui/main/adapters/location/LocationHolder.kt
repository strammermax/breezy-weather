...
import com.liveweatherwallpaperapp.common.extensions.DEFAULT_CARD_LIST_ITEM_ELEVATION_DP
...
class LocationHolder(
    ...
    fun onBindView(context: Context, model: LocationModel, resourceProvider: ResourceProvider) {
        val elevatedSurfaceColor = com.liveweatherwallpaperapp.common.utils.ColorUtils.getWidgetSurfaceColor(
