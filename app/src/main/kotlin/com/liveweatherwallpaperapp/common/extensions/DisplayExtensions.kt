...
package com.liveweatherwallpaperapp.common.extensions
...
val Context.isBackgroundAnimationEnabled: Boolean
    get() {
        val mode = com.liveweatherwallpaperapp.domain.settings.SettingsManager.getInstance(this).backgroundAnimationMode
        return when (mode) {
            com.liveweatherwallpaperapp.common.options.appearance.BackgroundAnimationMode.SYSTEM -> !isMotionReduced
            com.liveweatherwallpaperapp.common.options.appearance.BackgroundAnimationMode.ENABLED -> true
            com.liveweatherwallpaperapp.common.options.appearance.BackgroundAnimationMode.DISABLED -> false
        }
    }
