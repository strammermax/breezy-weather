...
package com.liveweatherwallpaperapp.data
...
val appTranslators = arrayOf(
    ...
    TranslatorItem(arrayOf("az"), "Aydin Salmanli", weblate = "aydin.salmanli"),
    ...
    TranslatorItem(arrayOf("bg"), "Bitcoin Fifty", weblate = "bitcoin.fifty"),
    ...
    TranslatorItem(arrayOf("he", "iw"), " Omer I.S.", github = "omeritzics"),
    ...
    TranslatorItem(arrayOf("pt"), "doncanjas", weblate = "doncanjas"),
