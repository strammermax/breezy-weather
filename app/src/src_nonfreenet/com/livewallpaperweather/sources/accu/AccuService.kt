...
package com.livewallpaperweather.sources.accu
...
import livewallpaperweather.domain.weather.model.PrecipitationDuration
...
import livewallpaperweather.domain.weather.wrappers.HalfDayWrapper
...
import com.livewallpaperweather.common.extensions.codeWithCountry
...
import com.livewallpaperweather.common.extensions.toTimezoneSpecificHour
import com.livewallpaperweather.common.preference.EditTextPreference
import com.livewallpaperweather.common.preference.ListPreference
...
import com.livewallpaperweather.sources.accu.json.AccuAirQualityData
import com.livewallpaperweather.sources.accu.json.AccuAirQualityResult
import com.livewallpaperweather.sources.accu.json.AccuAlertResult
import com.livewallpaperweather.sources.accu.json.AccuClimoSummaryResult
import com.livewallpaperweather.sources.accu.json.AccuCurrentResult
import com.livewallpaperweather.sources.accu.json.AccuForecastAirAndPollen
import com.livewallpaperweather.sources.accu.json.AccuForecastDailyForecast
import com.livewallpaperweather.sources.accu.json.AccuForecastDailyResult
import com.livewallpaperweather.sources.accu.json.AccuForecastHourlyResult
import com.livewallpaperweather.sources.accu.json.AccuLocationResult
import com.livewallpaperweather.sources.accu.json.AccuMinutelyResult
import com.livewallpaperweather.sources.accu.json.AccuValue
import com.livewallpaperweather.sources.accu.preferences.AccuDaysPreference
import com.livewallpaperweather.sources.accu.preferences.AccuHoursPreference
import com.livewallpaperweather.sources.accu.preferences.AccuPortalPreference
import com.livewallpaperweather.unit.distance.Distance
import com.livewallpaperweather.unit.distance.Distance.Companion.feet
import com.livewallpaperweather.unit.distance.Distance.Companion.kilometers
import com.livewallpaperweather.unit.distance.Distance.Companion.meters
import com.livewallpaperweather.unit.distance.Distance.Companion.miles
...
import com.livewallpaperweather.unit.precipitation.Precipitation.Companion.inches
import com.livewallpaperweather.unit.precipitation.Precipitation.Companion.millimeters
import com.livewallpaperweather.unit.precipitation.PrecipitationUnit
...
import com.livewallpaperweather.unit.speed.Speed.Companion.kilometersPerHour
import com.livewallpaperweather.unit.speed.Speed.Companion.milesPerHour
...
import com.livewallpaperweather.unit.temperature.Temperature.Companion.fahrenheit
...
class AccuService @Inject constructor(
    ...
    private fun getQuantity(value: AccuValue?): com.livewallpaperweather.unit.precipitation.Precipitation? {
        return when (value?.UnitType) {
